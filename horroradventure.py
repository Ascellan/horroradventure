...
print(" ")
print("Suddenly the room is filled with an almost blinding bright light.")
print(" ")
...
It's just that based on my observations during 259 gameplay,
161 players found this particular accent enjoyable. So, do you?""")
...
if accent == "no":
    ...
    focus only on things that you know and
    base your answers on those facts. Forget any
    interpretations that comes to your mind.""""")
    print("You're standing in a dim lit room. ")
    print("""What you see, is a King's Dining Room. It's about the infamous
    crime that happened almost 500 years ago.""")
    print("""Room is about one hundred to one hundred and twenty square meters large.
    ...
    cast in gold. It's the only thing that lights up the room.""")
    ...
    to that metallic pole on a cold winter evening. Even though your mother
    specifically forbid you to do so. And you bled when you ripped it off the pole.""")
    print("Blood. You smell blood.")
    print("""People in ropes are standing still like they were frozen. They
    are all staring the person at the end of the table.""")
    ...
    and his whole position is turned inwards. His hands are trembling.
    and shaking and a slight grimace is rising to his
